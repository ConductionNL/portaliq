...
/**
 * Portaliq DeepLinkRegistrationListener
 *
 * Registers Portaliq's deep link URL patterns with OpenRegister's search provider.
 *
 * @category Listener
 ...
 * Registers Portaliq's deep link URL patterns with OpenRegister's search provider.
 *
 * When a user searches in Nextcloud's unified search, results for Portaliq schemas
...
class DeepLinkRegistrationListener implements IEventListener
{
    ...
    public function handle(Event $event): void
    {
        ...
        // Replace 'portaliq' with your app ID and update the register slug,
        // schema slug, and URL template to match your app's actual schemas.
        $event->register(
            appId: 'portaliq',
            registerSlug: 'portaliq',
            schemaSlug: 'example',
            urlTemplate: '/apps/portaliq/#/examples/{uuid}'
        );
