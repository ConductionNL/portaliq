...
- @e2e exclude negative path — covered by PHPUnit (`ContributionControllerTest::testFailedDomainWriteNeverTriggersReceiptRecord`, `testForbiddenCreateNeverTriggersReceiptRecord`); no UI surface
